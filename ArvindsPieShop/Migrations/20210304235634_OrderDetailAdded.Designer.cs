...
namespace ArvindsPieShop.Migrations
{
    ...
    [Migration("20210304235634_OrderDetailAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("ArvindsPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArvindsPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArvindsPieShop.Models.Pie", b =>
                {
                    b.HasOne("ArvindsPieShop.Models.Category", "Category")
                        .WithMany("Pies")
